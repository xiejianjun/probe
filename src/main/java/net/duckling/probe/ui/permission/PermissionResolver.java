...
import net.duckling.probe.ui.permission.annotation.OnDeny;
import net.duckling.probe.ui.permission.annotation.RequirePermission;

import org.springframework.core.annotation.AnnotationUtils;

public class PermissionResolver {
	private Map<String, ControllerPermissions> controllers = Collections
			.synchronizedMap(new HashMap<String, ControllerPermissions>());
	...
	private static class ControllerPermissions {
		...
		private Map<String, Method> denyProcessor;

		private Method defaultDenyProcessor;

		private Map<String, RequirePermission> methodCache;
